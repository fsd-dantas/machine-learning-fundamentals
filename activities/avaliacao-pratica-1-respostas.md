...
| 2 — Extração de características | `resnet50_svm` | **0,8761** | 0,8695–0,8824 | 0,8767 | 128px | 0 | 1,0 min |
...
A diferença de 10,64 pp é **significativa** (α = 0,05). O primeiro colocado é, portanto, o melhor modelo desta comparação.
...
|---|---|---|---|
| Estratégia 2 vs. 1 | +11,25 pp | 3,45e-133 | **sim** |
| Estratégia 3 vs. 1 | +9,22 pp | 8,16e-89 | **sim** |
| Estratégia 3 vs. 2 | -2,03 pp | 1,11e-07 | **sim** |
| Estratégia 4 vs. 1 | +10,14 pp | 2,86e-109 | **sim** |
| Estratégia 4 vs. 2 | -1,11 pp | 0,0037 | **sim** |
| Estratégia 4 vs. 3 | +0,92 pp | 0,000397 | **sim** |
| Estratégia 5 vs. 1 | +21,89 pp | 0 | **sim** |
| Estratégia 5 vs. 2 | +10,64 pp | 3,63e-257 | **sim** |
...
| 2 — Extração de características | 0,8761 | 1,0 min | +11,25 pp | +11,14 |
...
**Resposta: sim, e a substituição melhora o resultado.** O `GlobalMaxPooling2D()` (0,8558) supera o `Flatten()` (0,8470) em **+1,19 pontos percentuais**, com significância (p = 9,4 × 10⁻⁵). O `GlobalAveragePooling2D()`, incluído como terceiro braço, atinge **0,8576** — o melhor dos três —, mas **empata tecnicamente** com o `GlobalMaxPooling2D()` (Δ = +0,14 pp; p = 0,598). A conclusão precisa é, portanto: **qualquer agrupamento global supera o achatamento; entre média e máximo, não há diferença detectável neste protocolo.**
